<?php
/**
 * Organizational chart page generator (Arabic).
 * Run with: php _build/generate-orgchart.php
 */
...
<header class="site-header">
    <div class="utility-bar">
        <div class="container utility-bar__inner">
            ...
            <a class="icon-btn lang-switch" href="en/orgchart.html" aria-label="Switch to English">EN</a>
    ...
    <div class="container main-nav-row">
        ...
        <nav class="main-nav" id="mainNav" aria-label="التنقل الرئيسي">
            <ul class="main-nav__list">
                ...
                <li class="is-active"><a href="ministry-departments.html">عن الوزارة</a></li>
    ...
    <div class="breadcrumb-bar">
        <div class="container breadcrumb-bar__inner">
            <a class="breadcrumb-back" href="ministry-departments.html">
                ...
                العودة إلى إدارات الوزارة
            </a>
            <div class="breadcrumb-trail">
                <a href="index.html">الرئيسية</a>
                <span class="sep">/</span>
                <a href="ministry-departments.html">عن الوزارة</a>
                <span class="sep">/</span>
                <span class="current">الهيكل التنظيمي</span>
            </div>
        </div>
    </div>
</header>
...
<footer class="site-footer">
    ...
    <div class="container footer-columns">
        <div><h3>المركز الإعلامي</h3><ul><li><a href="#">أخبار</a></li><li><a href="#">النماذج والتقارير</a></li><li><a href="#">موارد</a></li></ul></div>
        <div><h3>استثمر في قطر</h3><ul><li><a href="#">لماذا قطر</a></li><li><a href="#">خطوات الاستثمار</a></li><li><a href="#">الشراكات الدولية</a></li></ul></div>
        <div><h3>مركز الخدمات</h3><ul><li><a href="#">خدمات المستهلك</a></li><li><a href="#">منصة خدمات الصناعة</a></li><li><a href="#">خدمات المستثمر المحلي</a></li></ul></div>
        <div><h3>عن الوزارة</h3><ul><li><a href="ministry-departments.html">إدارات الوزارة</a></li><li><a href="leadership.html">وكلاء الوزارة</a></li><li><a href="#">اتصل بنا</a></li></ul></div>
    </div>
    <div class="container footer-bottom">
        <span>&copy; {$year} وزارة التجارة والصناعة. جميع الحقوق محفوظة.</span>
        <div class="footer-legal"><a href="#">خريطة الموقع</a><a href="#">شروط الاستخدام</a><a href="#">سياسة الخصوصية</a></div>
    </div>
</footer>
...
$floatingMenu = <<<HTML
<a class="floating-menu-btn" href="ministry-departments.html" aria-label="القائمة الرئيسية">
...
.orgchart-intro { text-align: center; max-width: 680px; margin: 0 auto 3rem; color: #555; font-size: .92rem; line-height: 1.9; padding: 1.2rem 2rem; background: #fff; border-radius: 12px; box-shadow: 0 1px 8px rgba(107,29,58,.06); border-right: 4px solid #6b1d3a; }
...
/* ---- Minister wrapper (deps positioned to the side) ---- */
.oc-minister-wrapper { position: relative; width: fit-content; }
.oc-minister-deps { position: absolute; top: 50%; transform: translateY(-50%); left: calc(100% + 1.5rem); display: flex; flex-direction: column; gap: .5rem; padding: .8rem; background: #fff; border-radius: var(--oc-radius); box-shadow: var(--oc-shadow); border-top: 3px solid var(--oc-gold); white-space: nowrap; }
...
.oc-state-branch { display: flex; flex-direction: column; align-items: center; align-self: flex-end; margin-inline-end: 15%; }

/* ---- Undersecretary sub-items row ---- */
.oc-under-subs { display: flex; gap: .8rem; justify-content: center; flex-wrap: wrap; margin-bottom: .5rem; }

/* ---- Grid for assistant undersecretaries ---- */
...
<main id="main">
    <section class="hero" style="background-image: url('assets/img/hero-departments.png');">
        <div class="container hero__inner">
            <h1 class="hero__title">الهيكل التنظيمي</h1>
            <p class="hero__subtitle">الهيكل التنظيمي لوزارة التجارة والصناعة</p>
        </div>
    </section>

    <section class="orgchart-section orgchart">
        <div class="container">
            <p class="orgchart-intro">ترتيب الإدارات وفقًا للقرار الأميري رقم (39) لسنة 2022 بالهيكل التنظيمي للوزارة</p>
            ...
            <div class="oc-tree">
                ...
                <div class="oc-minister-wrapper">
                    <div class="oc-minister__badge">
                        <h2 class="oc-minister__title">وزير التجارة والصناعة</h2>
                    </div>
                    <div class="oc-minister-deps">
                        <a class="oc-minister-dep oc-minister-dep--gold" href="dept-22.html">مكتب الوزير</a>
                        <a class="oc-minister-dep" href="dept-3.html">المكتب الفني</a>
                        <a class="oc-minister-dep" href="dept-2.html">إدارة التدقيق الداخلي</a>
                        <a class="oc-minister-dep" href="dept-1.html">إدارة التعاون الدولي والاتفاقيات</a>
                        <a class="oc-minister-dep" href="dept-6.html">إدارة الشؤون القانونية</a>
                    </div>
                </div>
                ...
                <div class="oc-state-branch">
                    <div class="oc-node oc-node--gold">وزير الدولة لشؤون التجارة الخارجية</div>
                    <div class="oc-vline--short"></div>
                    <a class="oc-sub oc-sub--office" href="dept-23.html">مكتب وزير الدولة</a>
                </div>

                <div class="oc-vline"></div>

                <!-- Undersecretary -->
                <div class="oc-node">وكيل الوزارة</div>
                <div class="oc-vline--short"></div>
                <div class="oc-under-subs">
                    <a class="oc-sub oc-sub--office" href="dept-24.html">مكتب الوكيل</a>
                    <a class="oc-sub" href="dept-5.html">إدارة التخطيط والجودة والابتكار</a>
                </div>
                ...
                <div class="oc-grid">
                    ...
                    <div class="oc-card">
                        <div class="oc-card__head">وكيل الوزارة المساعد لشؤون التجارة</div>
                        ...
                        <div class="oc-card__body">
                            <a class="oc-sub oc-sub--office" href="dept-25.html">مكتب الوكيل المساعد لشؤون التجارة</a>
                            <a class="oc-sub" href="dept-4.html">إدارة التسجيل والتراخيص التجارية</a>
                            <a class="oc-sub" href="dept-9.html">إدارة شؤون الشركات</a>
                            <a class="oc-sub" href="dept-8.html">إدارة حماية حقوق الملكية الفكرية</a>
                            <a class="oc-sub" href="dept-7.html">إدارة النافذة الواحدة</a>
                        </div>
                    </div>

                    <!-- 2. Industry & Business Development -->
                    <div class="oc-card">
                        <div class="oc-card__head">وكيل الوزارة المساعد لشؤون الصناعة وتنمية الأعمال</div>
                        <div class="oc-card__icon"><svg viewBox="0 0 24 24"><path d="M2 20h20M5 20V10l7-7 7 7v10M9 20v-4h6v4"/></svg></div>
                        <div class="oc-card__body">
                            <a class="oc-sub oc-sub--office" href="dept-26.html">مكتب الوكيل المساعد لشؤون الصناعة وتنمية الأعمال</a>
                            <a class="oc-sub" href="dept-12.html">إدارة التنمية الصناعية</a>
                            <a class="oc-sub" href="dept-11.html">إدارة دعم تنافسية المنتج الوطني</a>
                            <a class="oc-sub" href="dept-10.html">إدارة تنمية الأعمال</a>
                            <a class="oc-sub" href="dept-15.html">إدارة تنمية التبادل التجاري وترويج الاستثمار</a>
                        </div>
                    </div>

                    <!-- 3. Consumer Affairs -->
                    <div class="oc-card">
                        <div class="oc-card__head">وكيل الوزارة المساعد لشؤون المستهلك</div>
                        ...
                        <div class="oc-card__body">
                            <a class="oc-sub oc-sub--office" href="dept-27.html">مكتب الوكيل المساعد لشؤون المستهلك</a>
                            <a class="oc-sub" href="dept-13.html">إدارة حماية المستهلك ومكافحة الغش التجاري</a>
                            <a class="oc-sub" href="dept-14.html">إدارة التموين والمخزون الاستراتيجي</a>
                            <a class="oc-sub" href="dept-18.html">إدارة التراخيص النوعية ومراقبة الأسواق</a>
                            <a class="oc-sub" href="dept-17.html">إدارة حماية المنافسة</a>
                        </div>
                    </div>

                    <!-- 4. Shared Services -->
                    <div class="oc-card">
                        <div class="oc-card__head">وكيل الوزارة المساعد لشؤون الخدمات المشتركة</div>
                        ...
                        <div class="oc-card__body">
                            <a class="oc-sub oc-sub--office" href="dept-28.html">مكتب الوكيل المساعد لشؤون الخدمات المشتركة</a>
                            <a class="oc-sub" href="dept-16.html">إدارة العلاقات العامة والاتصال</a>
                            <a class="oc-sub" href="dept-21.html">إدارة الموارد البشرية</a>
                            <a class="oc-sub" href="dept-20.html">إدارة الشؤون المالية والإدارية</a>
                            <a class="oc-sub" href="dept-19.html">إدارة نظم المعلومات</a>
                        </div>
                    </div>
...
$fullCss = $css . "\n" . $orgchartCss;
$html = page_shell(
    'الهيكل التنظيمي – وزارة التجارة والصناعة',
    'الهيكل التنظيمي لوزارة التجارة والصناعة وفقًا للقرار الأميري رقم 39 لسنة 2022',
    $body, $fullCss, $js
);

file_put_contents($root . '/orgchart.html', $html);
echo "Wrote orgchart.html\n";
